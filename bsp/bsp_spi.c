...
#if defined(SPI1)
static void BSP_SPI1_NSS_ENABLE(void)  { GPIO_ResetBits(SPI1_NSS_PORT, SPI1_NSS_BIT); nssStatus = true;  }
static void BSP_SPI1_NSS_DISABLE(void) { GPIO_SetBits(SPI1_NSS_PORT, SPI1_NSS_BIT);   nssStatus = false; }
#endif

#if defined(SPI2)
static void BSP_SPI2_NSS_ENABLE(void)  { GPIO_ResetBits(SPI2_NSS_PORT, SPI2_NSS_BIT); nssStatus = true;  }
static void BSP_SPI2_NSS_DISABLE(void) { GPIO_SetBits(SPI2_NSS_PORT, SPI2_NSS_BIT);   nssStatus = false; }
#endif
